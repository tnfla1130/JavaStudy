...
메인쓰레드가 종료되어도 계속 실행되며, Dead 상태가 되어야만 실행이
...
주로 프로그램의 보조역할로 배경음악재상, 자동저장 등의 업무를 처리한
	...
	public void run() {
		...
		while(true) {
			...
			try {
				...
				System.out.println("자동저장 시 오류발생ㅜㅜ");
			}
		}
	}
}
...
//		yt1.setName("First 쓰레드");
		...
		System.out.println("메인함수의ㅣ 우선순위:"+
