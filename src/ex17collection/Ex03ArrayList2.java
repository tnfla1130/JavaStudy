...
public class Ex03ArrayList2 {
	...
	public static void main(String[] args) {
		...
		차이가 없다. 인스턴스 생성시 Student형이 타입매개변수를
		통해 생성한다. Student를 저정할 수 있는 상자가 된다.
		 */
...
//		ArrayList<Student> list2 = new ArrayList<Student>();
		...
		된다. 또한 동일한 인스턴스가 존재한다면 앞에서부터 순서대로
		삭제된다. 즉 동시에 삭제되지 않는다.
		 */
		...
		반환할 원소가 있는지 확인한 후 true면 next()로 인출한다.
		 */
		...
		//남아있는 정보 2개가 출력된다.
		System.out.println("[출력2-확장 for문]");
		for(Student st : list2) {
