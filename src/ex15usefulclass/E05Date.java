...
public class E05Date {
	...
	public static void main(String[] args) {
		...
		new를 사용하는 대신 유틸리티 메서드인 fetInstance()를
		통해 참조값을 얻어온다.
		 */
		...
		2개월 3일후의 날짜가 출력된다.
		 */
		String nowStr3 = myDateFormat(calendar, "yyy년 MM월 dd일");
		System.out.println("1년 2개월 3일후:"+ nowStr3);
		
		/*
		올해 크리스마스까지 남은 날짜를 계산. 여기서는 두가지 서식의
		날짜를 파싱하여 구한 날짜 인스턴스로 계산한다.
		 */
		//오늘날짜 : 0000-00-00 형식
	...
	public static long myDiffDate(String today, String future) {
		...
		try {
			/*
			매개변수를 통해 전다로딘 2개의 문자열은 날짜의 서식이 서로 다르다.
			...
			같이 남은 날짜를 계산할 수 있다.
			 */
			System.out.println(formatToday.getTime());
