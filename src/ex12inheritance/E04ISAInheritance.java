...
따라서 실제 업무에서도 유사한 기능의 클래스들을 상속으로 묶에서 정의
하는 것이 좋다.
 */
 ...
 */
class TabletNotbook extends NotebookComputer {
	//테블릿 사용을 위한 펜을 표현
	String registPencil;
	//생성자 
	public TabletNotbook(String name, int initCharge
			, String pen) {
		super(name, initCharge);
		registPencil = pen;
	}
	//테블릿 사용을 위한 배터리 체크 및 들록된 펜인지 확인
	public void write(String penInfo) {
		...
		사용할 수 있다. 단 접근이 가능한 지정자로 선언되어야한다.
		super는 생략할 수 있다. */
		super.movingCal();
...
public class E04ISAInheritance {
	...
	public static void main(String[] args) {
		...
		//테블릿 인스턴스 생성
		TabletNotbook tablet =
				new TabletNotbook("이동욱", 5, "ISE-1234");
