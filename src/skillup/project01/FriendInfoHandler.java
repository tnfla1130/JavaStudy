...
/*
주소록관리 프로그램에서 기능을 담장하는 핸들러 클래스 정의.
mian메서드는 프로그램의 출발점의 역할만 담당하고, 모든 기능은 핸들러
클래스에서 구현한다.
 */
...
//		Scanner scan = new Scanner(System.in);
		...
		//공통정보 3가지를 입력받음
		System.out.println("이름:"); iName = MyFriendInfoBook.scan.nextLine();
		System.out.println("전화번호:"); iPhone = MyFriendInfoBook.scan.nextLine();
	...
	public void showAllData() {
		...
		/*
		고딩친구반복 : 저장된 정보의 갯수만큼 반복해서 전체 정보를
