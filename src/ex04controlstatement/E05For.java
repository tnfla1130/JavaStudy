...
public class E05For {
	...
	public static void main(String[] args) {
		...
		/*
		방법 2 : if문 없이 초깃값을 0부터 시작하여 2씩 증가시킴
		 */
		total =0;
		...
		/*
		fot문의 초기식에서 선언된 변수 j는 for문이 종료되는 순간 
...
//		System.out.println("위 for문에서 선언한 변수 j="+j);
		...
		선언하면 해당 변수는 for문 내부(좁은지역)에서 사용할 수 있다.
		...
		즉 if문, while문 등의 제어문도 지역을 가지게된다.
		 */
		...
		/*
		퀴즈] 구구단을 출력하는 프로그램을 for문으로 작성하시오.
		 */
